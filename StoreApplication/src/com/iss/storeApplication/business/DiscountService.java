...
public class DiscountService {
	...
	{
		if(StringUtility.isEmpty(discount.getDescription()) | StringUtility.isEmpty(discount.getDescription()) | StringUtility.isEmpty(discount.getDiscountCode()) | StringUtility.isEmpty(discount.getMemberApplicable()) | discount.getDiscount() == null)
		{
